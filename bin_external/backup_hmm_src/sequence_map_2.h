...
public:
    ...
    void CalcStartScoreForPosition(Model* m, std::vector<unsigned char> & nt, vector< MapValue >::iterator itr);
	void CalcStarts( Model* mod, std::vector<unsigned char> & nt);
	void CalcStartsGC(std::vector< Model* > & mod, std::vector<unsigned char> & nt);
