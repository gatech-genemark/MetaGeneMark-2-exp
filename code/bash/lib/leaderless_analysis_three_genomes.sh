...
function extract_motif_info_for_same_gene() {
    ...
    paste <(echo "$out_mgm2") <(echo "$out_mprodigal") --delimiters ','
...
function analyze_mgm2_vs_mprodigal() {
    ...
    echo "MGM2 Correct"
    extract_motif_info_for_same_gene $pf_mgm2_correct_mprodigal_incorrect_view_mgm2 $pf_mgm2_correct_mprodigal_incorrect_view_mprodigal

    echo "Mprodigal Correct"
    extract_motif_info_for_same_gene $pf_mprodigal_correct_mgm2_incorrect_view_mgm2 $pf_mprodigal_correct_mgm2_incorrect_view_mprodigal
}
